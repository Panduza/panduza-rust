...
pub mod panduza {
    ...
    impl Payload {
        ...
        pub const StructureNode: Self = Self(1);
        ...
        pub fn variant_name(self) -> Option<&'static str> {
            match self {
                Self::NONE => Some("NONE"),
                Self::StructureNode => Some("StructureNode"),
    ...
    impl<'a> Message<'a> {
        ...
        pub fn payload_as_structure_node(&self) -> Option<StructureNode<'a>> {
            if self.payload_type() == Payload::StructureNode {
                self.payload().map(|t| {
                    // Safety:
                    // Created from a valid Table for this object
                    // Which contains a valid union in this slot
                    unsafe { StructureNode::init_from_table(t) }
                })
            } else {
                None
            }
        ...
        fn run_verifier(
            ...
            v.visit_table(pos)?
                ...
                .visit_union::<Payload, _>(
                    ...
                    false,
                    |key, v, pos| match key {
                        Payload::StructureNode => v
                            .verify_union_variant::<flatbuffers::ForwardsUOffset<StructureNode>>(
                                "Payload::StructureNode",
                                pos,
                            ),
                        Payload::Context => v
    ...
    impl core::fmt::Debug for Message<'_> {
        fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
            ...
            match self.payload_type() {
                Payload::StructureNode => {
                    if let Some(x) = self.payload_as_structure_node() {
                        ds.field("payload", &x)
                    } else {
                        ds.field(
                            "payload",
    ...
    impl<'a> flatbuffers::Follow<'a> for AttributeEntry<'a> {
        type Inner = AttributeEntry<'a>;
        #[inline]
        unsafe fn follow(buf: &'a [u8], loc: usize) -> Self::Inner {
            Self {
                _tab: flatbuffers::Table::new(buf, loc),
    ...
    impl<'a> AttributeEntry<'a> {
        ...
        >(
            _fbb: &'mut_bldr mut flatbuffers::FlatBufferBuilder<'bldr, A>,
            args: &'args AttributeEntryArgs<'args>,
        ) -> flatbuffers::WIPOffset<AttributeEntry<'bldr>> {
            let mut builder = AttributeEntryBuilder::new(_fbb);
        ...
        pub fn name(&self) -> Option<&'a str> {
            ...
            unsafe {
                self._tab
                    .get::<flatbuffers::ForwardsUOffset<&str>>(AttributeEntry::VT_NAME, None)
            }
        }
        #[inline]
        pub fn type_(&self) -> Option<&'a str> {
            ...
            unsafe {
                self._tab
                    .get::<flatbuffers::ForwardsUOffset<&str>>(AttributeEntry::VT_TYPE_, None)
            }
        }
        #[inline]
        pub fn mode(&self) -> Option<&'a str> {
            ...
            unsafe {
                self._tab
                    .get::<flatbuffers::ForwardsUOffset<&str>>(AttributeEntry::VT_MODE, None)
            }
        }
    }

    impl flatbuffers::Verifiable for AttributeEntry<'_> {
        #[inline]
        fn run_verifier(
            v: &mut flatbuffers::Verifier,
            pos: usize,
    ...
    pub struct AttributeEntryArgs<'a> {
        pub name: Option<flatbuffers::WIPOffset<&'a str>>,
        pub type_: Option<flatbuffers::WIPOffset<&'a str>>,
        pub mode: Option<flatbuffers::WIPOffset<&'a str>>,
    }
    impl<'a> Default for AttributeEntryArgs<'a> {
        #[inline]
        fn default() -> Self {
            AttributeEntryArgs {
                name: None,
    ...
    pub struct AttributeEntryBuilder<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> {
        fbb_: &'b mut flatbuffers::FlatBufferBuilder<'a, A>,
        start_: flatbuffers::WIPOffset<flatbuffers::TableUnfinishedWIPOffset>,
    }
    impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> AttributeEntryBuilder<'a, 'b, A> {
        #[inline]
        pub fn add_name(&mut self, name: flatbuffers::WIPOffset<&'b str>) {
            self.fbb_
                .push_slot_always::<flatbuffers::WIPOffset<_>>(AttributeEntry::VT_NAME, name);
        }
        #[inline]
        pub fn add_type_(&mut self, type_: flatbuffers::WIPOffset<&'b str>) {
            self.fbb_
                .push_slot_always::<flatbuffers::WIPOffset<_>>(AttributeEntry::VT_TYPE_, type_);
        }
        #[inline]
        pub fn add_mode(&mut self, mode: flatbuffers::WIPOffset<&'b str>) {
            self.fbb_
                .push_slot_always::<flatbuffers::WIPOffset<_>>(AttributeEntry::VT_MODE, mode);
        }
        #[inline]
        pub fn new(
            _fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>,
        ) -> AttributeEntryBuilder<'a, 'b, A> {
            let start = _fbb.start_table();
            AttributeEntryBuilder {
                fbb_: _fbb,
                start_: start,
            }
        }
        #[inline]
        pub fn finish(self) -> flatbuffers::WIPOffset<AttributeEntry<'a>> {
            let o = self.fbb_.end_table(self.start_);
            flatbuffers::WIPOffset::new(o.value())
        }
    }

    impl core::fmt::Debug for AttributeEntry<'_> {
        fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
            let mut ds = f.debug_struct("AttributeEntry");
    ...
    pub enum StructureNodeOffset {}
    #[derive(Copy, Clone, PartialEq)]

    pub struct StructureNode<'a> {
        pub _tab: flatbuffers::Table<'a>,
    }

    impl<'a> flatbuffers::Follow<'a> for StructureNode<'a> {
        type Inner = StructureNode<'a>;
        #[inline]
        unsafe fn follow(buf: &'a [u8], loc: usize) -> Self::Inner {
            Self {
                _tab: flatbuffers::Table::new(buf, loc),
    ...
    impl<'a> StructureNode<'a> {
        ...
        >(
            _fbb: &'mut_bldr mut flatbuffers::FlatBufferBuilder<'bldr, A>,
            args: &'args StructureNodeArgs<'args>,
        ) -> flatbuffers::WIPOffset<StructureNode<'bldr>> {
            let mut builder = StructureNodeBuilder::new(_fbb);
        ...
        pub fn name(&self) -> Option<&'a str> {
            ...
            unsafe {
                self._tab
                    .get::<flatbuffers::ForwardsUOffset<&str>>(StructureNode::VT_NAME, None)
            }
        }
        #[inline]
        pub fn tags(
            ...
            unsafe {
                ...
                >>(StructureNode::VT_TAGS, None)
            }
        }
        #[inline]
        pub fn children(
            &self,
        ) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<StructureNode<'a>>>>
        {
            // Safety:
            // Created from valid Table for this object
            // which contains a valid value in this slot
            unsafe {
                self._tab.get::<flatbuffers::ForwardsUOffset<
                    flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<StructureNode>>,
                >>(StructureNode::VT_CHILDREN, None)
            }
        }
        #[inline]
        pub fn attributes(
            &self,
        ) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<AttributeEntry<'a>>>>
        {
            // Safety:
            // Created from valid Table for this object
            // which contains a valid value in this slot
            unsafe {
                self._tab.get::<flatbuffers::ForwardsUOffset<
                    flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<AttributeEntry>>,
                >>(StructureNode::VT_ATTRIBUTES, None)
            }
        }
    }

    impl flatbuffers::Verifiable for StructureNode<'_> {
        #[inline]
        fn run_verifier(
            v: &mut flatbuffers::Verifier,
            pos: usize,
            ...
            v.visit_table(pos)?
                ...
                .visit_field::<flatbuffers::ForwardsUOffset<
                    flatbuffers::Vector<'_, flatbuffers::ForwardsUOffset<StructureNode>>,
                >>("children", Self::VT_CHILDREN, false)?
                .visit_field::<flatbuffers::ForwardsUOffset<
                    flatbuffers::Vector<'_, flatbuffers::ForwardsUOffset<AttributeEntry>>,
                >>("attributes", Self::VT_ATTRIBUTES, false)?
                .finish();
            Ok(())
        }
    }
    pub struct StructureNodeArgs<'a> {
        pub name: Option<flatbuffers::WIPOffset<&'a str>>,
        pub tags: Option<
        ...
        pub children: Option<
            flatbuffers::WIPOffset<
                flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<StructureNode<'a>>>,
            >,
        >,
        pub attributes: Option<
            flatbuffers::WIPOffset<
                flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<AttributeEntry<'a>>>,
            >,
        >,
    }
    impl<'a> Default for StructureNodeArgs<'a> {
        #[inline]
        fn default() -> Self {
            StructureNodeArgs {
                name: None,
    ...
    pub struct StructureNodeBuilder<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> {
        fbb_: &'b mut flatbuffers::FlatBufferBuilder<'a, A>,
        start_: flatbuffers::WIPOffset<flatbuffers::TableUnfinishedWIPOffset>,
    }
    impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> StructureNodeBuilder<'a, 'b, A> {
        #[inline]
        pub fn add_name(&mut self, name: flatbuffers::WIPOffset<&'b str>) {
            self.fbb_
                .push_slot_always::<flatbuffers::WIPOffset<_>>(StructureNode::VT_NAME, name);
        }
        #[inline]
        pub fn add_tags(
            &mut self,
            ...
            self.fbb_
                .push_slot_always::<flatbuffers::WIPOffset<_>>(StructureNode::VT_TAGS, tags);
        }
        #[inline]
        pub fn add_children(
            &mut self,
            children: flatbuffers::WIPOffset<
                flatbuffers::Vector<'b, flatbuffers::ForwardsUOffset<StructureNode<'b>>>,
            >,
        ) {
            self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(
                StructureNode::VT_CHILDREN,
                children,
            );
        }
        #[inline]
        pub fn add_attributes(
            ...
            attributes: flatbuffers::WIPOffset<
                flatbuffers::Vector<'b, flatbuffers::ForwardsUOffset<AttributeEntry<'b>>>,
            >,
        ) {
            self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(
                StructureNode::VT_ATTRIBUTES,
                attributes,
            );
        }
        #[inline]
        pub fn new(
            _fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>,
        ) -> StructureNodeBuilder<'a, 'b, A> {
            let start = _fbb.start_table();
            StructureNodeBuilder {
                fbb_: _fbb,
                start_: start,
            }
        }
        #[inline]
        pub fn finish(self) -> flatbuffers::WIPOffset<StructureNode<'a>> {
            let o = self.fbb_.end_table(self.start_);
            flatbuffers::WIPOffset::new(o.value())
        }
    }

    impl core::fmt::Debug for StructureNode<'_> {
        fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
            let mut ds = f.debug_struct("StructureNode");
            ds.field("name", &self.name());
    ...
    impl<'a> Context<'a> {
        ...
        pub fn topic(&self) -> Option<&'a str> {
            ...
            unsafe {
                self._tab
                    .get::<flatbuffers::ForwardsUOffset<&str>>(Context::VT_TOPIC, None)
            }
        }
        #[inline]
        pub fn context(&self) -> Option<&'a str> {
            ...
            unsafe {
                self._tab
                    .get::<flatbuffers::ForwardsUOffset<&str>>(Context::VT_CONTEXT, None)
            }
        }
    }
