...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> HeaderBuilder<'a, 'b, A> {
  ...
  pub fn add_timestamp(&mut self, timestamp: &Timestamp) {
    self.fbb_.push_slot_always::<&Timestamp>(Header::VT_TIMESTAMP, timestamp);
  }
  #[inline]
...
impl<'a> Message<'a> {
  ...
  pub fn header(&self) -> Option<Header<'a>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<Header>>(Message::VT_HEADER, None)}
  }
  #[inline]
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     ...
     .visit_union::<Payload, _>("payload_type", Self::VT_PAYLOAD_TYPE, "payload", Self::VT_PAYLOAD, false, |key, v, pos| {
        match key {
          Payload::Status => v.verify_union_variant::<flatbuffers::ForwardsUOffset<Status>>("Payload::Status", pos),
          Payload::Notification => v.verify_union_variant::<flatbuffers::ForwardsUOffset<Notification>>("Payload::Notification", pos),
          Payload::Boolean => v.verify_union_variant::<flatbuffers::ForwardsUOffset<Boolean>>("Payload::Boolean", pos),
          Payload::Bytes => v.verify_union_variant::<flatbuffers::ForwardsUOffset<Bytes>>("Payload::Bytes", pos),
          Payload::Number => v.verify_union_variant::<flatbuffers::ForwardsUOffset<Number>>("Payload::Number", pos),
          Payload::Trigger => v.verify_union_variant::<flatbuffers::ForwardsUOffset<Trigger>>("Payload::Trigger", pos),
          Payload::String => v.verify_union_variant::<flatbuffers::ForwardsUOffset<String>>("Payload::String", pos),
          Payload::VectorF32 => v.verify_union_variant::<flatbuffers::ForwardsUOffset<VectorF32>>("Payload::VectorF32", pos),
          _ => Ok(()),
        }
     })?
     .finish();
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> MessageBuilder<'a, 'b, A> {
  ...
  pub fn add_header(&mut self, header: flatbuffers::WIPOffset<Header<'b >>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<Header>>(Message::VT_HEADER, header);
  }
  #[inline]
...
impl<'a> Bytes<'a> {
  ...
  pub fn data(&self) -> Option<flatbuffers::Vector<'a, u8>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u8>>>(Bytes::VT_DATA, None)}
  }
}
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> BytesBuilder<'a, 'b, A> {
  ...
  pub fn add_data(&mut self, data: flatbuffers::WIPOffset<flatbuffers::Vector<'b , u8>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(Bytes::VT_DATA, data);
  }
  #[inline]
...
impl<'a> Unit<'a> {
  ...
  pub fn prefix(&self) -> SIPrefix {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<SIPrefix>(Unit::VT_PREFIX, Some(SIPrefix::NONE)).unwrap()}
  }
  #[inline]
  pub fn unit(&self) -> SIUnit {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<SIUnit>(Unit::VT_UNIT, Some(SIUnit::NONE)).unwrap()}
  }
}
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> UnitBuilder<'a, 'b, A> {
  ...
  pub fn add_prefix(&mut self, prefix: SIPrefix) {
    self.fbb_.push_slot::<SIPrefix>(Unit::VT_PREFIX, prefix, SIPrefix::NONE);
  }
  #[inline]
  pub fn add_unit(&mut self, unit: SIUnit) {
    self.fbb_.push_slot::<SIUnit>(Unit::VT_UNIT, unit, SIUnit::NONE);
  }
  #[inline]
...
impl<'a> NumberRange<'a> {
  ...
  pub fn min(&self) -> f64 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<f64>(NumberRange::VT_MIN, Some(0.0)).unwrap()}
  }
  #[inline]
  pub fn max(&self) -> f64 {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<f64>(NumberRange::VT_MAX, Some(0.0)).unwrap()}
  }
}
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> NumberRangeBuilder<'a, 'b, A> {
  ...
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>) -> NumberRangeBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
    NumberRangeBuilder {
      fbb_: _fbb,
      start_: start,
...
impl<'a> Number<'a> {
  ...
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr, A: flatbuffers::Allocator + 'bldr>(
    ...
    builder.add_value(args.value);
    if let Some(x) = args.whitelist { builder.add_whitelist(x); }
  ...
  pub fn unit(&self) -> Option<Unit<'a>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<Unit>>(Number::VT_UNIT, None)}
  }
  #[inline]
  ...
  pub fn range(&self) -> Option<NumberRange<'a>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<NumberRange>>(Number::VT_RANGE, None)}
  }
  #[inline]
  pub fn whitelist(&self) -> Option<flatbuffers::Vector<'a, f64>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, f64>>>(Number::VT_WHITELIST, None)}
  }
}
...
impl flatbuffers::Verifiable for Number<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     ...
     .visit_field::<flatbuffers::ForwardsUOffset<NumberRange>>("range", Self::VT_RANGE, false)?
     .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, f64>>>("whitelist", Self::VT_WHITELIST, false)?
     .finish();
    Ok(())
  }
}
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> NumberBuilder<'a, 'b, A> {
  ...
  pub fn add_unit(&mut self, unit: flatbuffers::WIPOffset<Unit<'b >>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<Unit>>(Number::VT_UNIT, unit);
  }
  #[inline]
  ...
  pub fn add_range(&mut self, range: flatbuffers::WIPOffset<NumberRange<'b >>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<NumberRange>>(Number::VT_RANGE, range);
  }
  #[inline]
  pub fn add_whitelist(&mut self, whitelist: flatbuffers::WIPOffset<flatbuffers::Vector<'b , f64>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(Number::VT_WHITELIST, whitelist);
  }
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>) -> NumberBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
    NumberBuilder {
      fbb_: _fbb,
      start_: start,
...
impl<'a> Trigger<'a> {
  ...
  pub fn refresh(&self) -> f64 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<f64>(Trigger::VT_REFRESH, Some(0.0)).unwrap()}
  }
  #[inline]
  pub fn range(&self) -> Option<NumberRange<'a>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<NumberRange>>(Trigger::VT_RANGE, None)}
  }
  #[inline]
  pub fn whitelist(&self) -> Option<flatbuffers::Vector<'a, f64>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, f64>>>(Trigger::VT_WHITELIST, None)}
  }
}
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> TriggerBuilder<'a, 'b, A> {
  ...
  pub fn add_refresh(&mut self, refresh: f64) {
    self.fbb_.push_slot::<f64>(Trigger::VT_REFRESH, refresh, 0.0);
  }
  #[inline]
  pub fn add_range(&mut self, range: flatbuffers::WIPOffset<NumberRange<'b >>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<NumberRange>>(Trigger::VT_RANGE, range);
  }
  #[inline]
  pub fn add_whitelist(&mut self, whitelist: flatbuffers::WIPOffset<flatbuffers::Vector<'b , f64>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(Trigger::VT_WHITELIST, whitelist);
  }
  #[inline]
...
impl<'a> String<'a> {
  ...
  #[inline]
  pub fn whitelist(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>>>(String::VT_WHITELIST, None)}
  }
}
...
impl flatbuffers::Verifiable for String<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     ...
     .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, flatbuffers::ForwardsUOffset<&'_ str>>>>("whitelist", Self::VT_WHITELIST, false)?
     .finish();
    Ok(())
  }
}
pub struct StringArgs<'a> {
    ...
    pub whitelist: Option<flatbuffers::WIPOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>>>,
}
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> StringBuilder<'a, 'b, A> {
  ...
  #[inline]
  pub fn add_whitelist(&mut self, whitelist: flatbuffers::WIPOffset<flatbuffers::Vector<'b , flatbuffers::ForwardsUOffset<&'b  str>>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(String::VT_WHITELIST, whitelist);
  }
  #[inline]
