...
pub mod panduza {
    ...
    impl<'a> flatbuffers::Follow<'a> for ClassEntry<'a> {
        type Inner = ClassEntry<'a>;
        #[inline]
        unsafe fn follow(buf: &'a [u8], loc: usize) -> Self::Inner {
            Self {
                _tab: flatbuffers::Table::new(buf, loc),
    ...
    impl<'a> ClassEntry<'a> {
        ...
        >(
            _fbb: &'mut_bldr mut flatbuffers::FlatBufferBuilder<'bldr, A>,
            args: &'args ClassEntryArgs<'args>,
        ) -> flatbuffers::WIPOffset<ClassEntry<'bldr>> {
            let mut builder = ClassEntryBuilder::new(_fbb);
            if let Some(x) = args.classes {
                builder.add_classes(x);
            }
        ...
        pub fn name(&self) -> Option<&'a str> {
            ...
            unsafe {
                self._tab
                    .get::<flatbuffers::ForwardsUOffset<&str>>(ClassEntry::VT_NAME, None)
            }
        }
        #[inline]
        pub fn tags(
        ...
        ) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<AttributeEntry<'a>>>>
        {
            ...
            unsafe {
                ...
                >>(ClassEntry::VT_ATTRIBUTES, None)
            }
        }
        #[inline]
        pub fn classes(
            &self,
        ) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<ClassEntry<'a>>>> {
            // Safety:
            // Created from valid Table for this object
            // which contains a valid value in this slot
            unsafe {
                self._tab.get::<flatbuffers::ForwardsUOffset<
                    flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<ClassEntry>>,
                >>(ClassEntry::VT_CLASSES, None)
            }
        }
    }

    impl flatbuffers::Verifiable for ClassEntry<'_> {
        #[inline]
        fn run_verifier(
            v: &mut flatbuffers::Verifier,
            pos: usize,
            ...
            v.visit_table(pos)?
                ...
                .visit_field::<flatbuffers::ForwardsUOffset<
                    flatbuffers::Vector<'_, flatbuffers::ForwardsUOffset<ClassEntry>>,
                >>("classes", Self::VT_CLASSES, false)?
                .finish();
            Ok(())
        }
    }
    pub struct ClassEntryArgs<'a> {
        pub name: Option<flatbuffers::WIPOffset<&'a str>>,
        pub tags: Option<
        ...
        pub classes: Option<
            flatbuffers::WIPOffset<
                flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<ClassEntry<'a>>>,
            >,
        >,
    }
    impl<'a> Default for ClassEntryArgs<'a> {
        #[inline]
        fn default() -> Self {
            ClassEntryArgs {
                name: None,
    ...
    pub struct ClassEntryBuilder<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> {
        fbb_: &'b mut flatbuffers::FlatBufferBuilder<'a, A>,
        start_: flatbuffers::WIPOffset<flatbuffers::TableUnfinishedWIPOffset>,
    }
    impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> ClassEntryBuilder<'a, 'b, A> {
        #[inline]
        pub fn add_name(&mut self, name: flatbuffers::WIPOffset<&'b str>) {
            self.fbb_
                .push_slot_always::<flatbuffers::WIPOffset<_>>(ClassEntry::VT_NAME, name);
        }
        #[inline]
        pub fn add_tags(
            &mut self,
            ...
            self.fbb_
                .push_slot_always::<flatbuffers::WIPOffset<_>>(ClassEntry::VT_TAGS, tags);
        }
        #[inline]
        ...
        pub fn add_classes(
            &mut self,
            classes: flatbuffers::WIPOffset<
                flatbuffers::Vector<'b, flatbuffers::ForwardsUOffset<ClassEntry<'b>>>,
            >,
        ) {
            self.fbb_
                .push_slot_always::<flatbuffers::WIPOffset<_>>(ClassEntry::VT_CLASSES, classes);
        }
        #[inline]
        pub fn new(
            _fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>,
        ) -> ClassEntryBuilder<'a, 'b, A> {
            let start = _fbb.start_table();
            ClassEntryBuilder {
                fbb_: _fbb,
                start_: start,
        ...
        #[inline]
        pub fn finish(self) -> flatbuffers::WIPOffset<ClassEntry<'a>> {
            let o = self.fbb_.end_table(self.start_);
            flatbuffers::WIPOffset::new(o.value())
        }
    }

    impl core::fmt::Debug for ClassEntry<'_> {
        fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
            let mut ds = f.debug_struct("ClassEntry");
            ds.field("name", &self.name());
    ...
    impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> StructureBuilder<'a, 'b, A> {
        ...
        pub fn add_classes(
            ...
            self.fbb_
                .push_slot_always::<flatbuffers::WIPOffset<_>>(Structure::VT_CLASSES, classes);
        }
        #[inline]
        pub fn new(
            _fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>,
