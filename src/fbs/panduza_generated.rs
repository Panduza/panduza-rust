...
pub mod panduza {
    ...
    impl<'a> ContextEntry<'a> {
        ...
        pub fn topic(&self) -> Option<&'a str> {
            ...
            unsafe {
                self._tab
                    .get::<flatbuffers::ForwardsUOffset<&str>>(ContextEntry::VT_TOPIC, None)
            }
        }
        #[inline]
        pub fn context(&self) -> Option<&'a str> {
            ...
            unsafe {
                self._tab
                    .get::<flatbuffers::ForwardsUOffset<&str>>(ContextEntry::VT_CONTEXT, None)
            }
        }
    }
    ...
    impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> ContextEntryBuilder<'a, 'b, A> {
        ...
        pub fn add_topic(&mut self, topic: flatbuffers::WIPOffset<&'b str>) {
            self.fbb_
                .push_slot_always::<flatbuffers::WIPOffset<_>>(ContextEntry::VT_TOPIC, topic);
        }
        #[inline]
        pub fn add_context(&mut self, context: flatbuffers::WIPOffset<&'b str>) {
            self.fbb_
                .push_slot_always::<flatbuffers::WIPOffset<_>>(ContextEntry::VT_CONTEXT, context);
        }
        #[inline]
        pub fn new(
            _fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>,
        ) -> ContextEntryBuilder<'a, 'b, A> {
            let start = _fbb.start_table();
            ContextEntryBuilder {
                fbb_: _fbb,
                start_: start,
